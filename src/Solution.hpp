...
// Class containing a solution to a TOPTW Problem, i.e. routes and unserved customers are stored
class Solution
{
public:
    ...
    // Solution score - sum of scores of all routes
    int total_score;

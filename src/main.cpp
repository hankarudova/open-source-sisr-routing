...
int main(int argc, char *argv[])
{
    ...
    cxxopts::Options options("solver", "Open-source C++ implementation of Slack Induction by String Removals for capacitated team orienteering problem");
    options.add_options()
    ...
    {
        if (!readProblemFileCTOP(instance_path, problem))
        {

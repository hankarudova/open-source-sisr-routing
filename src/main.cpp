...
int main(int argc, char *argv[])
{
    ...
    cxxopts::Options options("solver", "Open-source C++ implementation of Slack Induction by String Removals for pickup and delivery problem with time windows");
    options.add_options()
    ...
    {
        if (!readProblemFilePDPTW(instance_path, problem))
        {

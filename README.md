# Open-source C++ implementation of Slack Induction by String Removals for team orienteering problem
...
The instances were obtained from https://github.com/CharlyChgn/VLS-Team-Orienteering-Problem
...
setup used in the given run. Start and end depot locations have the first and last indices, i.e., 0 and the number of 
customers + 1. The remaining customer location indices start from 1 and go up to the number of customers in the problem.


## Literature

[1] Dang, D.C., Guibadj, R.N., Moukrim, A.: An effective PSO-inspired algorithm for
the team orienteering problem. European Journal of Operational Research 229(2),
332–344 (2013)
